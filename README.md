...
A Swift package that wraps [libgit2](https://libgit2.org) with an idiomatic, async-first API designed for apps that work with real-world, authenticated repositories.

**Website:** [gittykit.dev](https://gittykit.dev) · [Website repo](https://github.com/RonenMars/gitty-site)
**Platforms:** iOS 15+ · macOS 12+
**Swift:** 5.9+

## Why Gitty?

Existing Swift libgit2 wrappers either lack SPM support, are unmaintained,
or are missing operations that real-world apps need: authenticated push/pull,
typed diffs, merge with conflict detection, stash, rebase, blame, and worktrees.
Gitty provides all of these with a modern async/await API and zero system dependencies.
...
Gitty depends on [RonenMars/libgit2](https://github.com/RonenMars/libgit2),
a fork of the official [libgit2/libgit2](https://github.com/libgit2/libgit2)
C library packaged for Swift Package Manager. No other dependencies.
